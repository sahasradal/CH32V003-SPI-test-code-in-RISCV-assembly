...
W_WDG_BASE = 0x40002C00
I_WDG_BASE = 0x40003000
I2C_BASE = 0x40005400
PWR_BASE = 0x40007000
AFIO_BASE = 0x40010000
EXTI_BASE = 0x40010400
PORTA_BASE = 0x40010800
PORTC_BASE = 0x40011000
PORTD_BASE = 0x40011400
ADC_BASE = 0x40012400
...
EXTENDED_MEM_BASE = 0x40023800
CORE_PRIVATE_BASE = 0xE0000000
FLASH_BASE = 0x08000000


R32_PWR_CTLR    = 0x40007000 	#Power control register
R32_PWR_CSR     = 0x40007004 	#Power control/status register
R32_PWR_AWUCSR 	= 0x40007008 	#Auto-wakeup control/status register
R32_PWR_AWUWR 	= 0x4000700C	#Auto-wakeup window comparison value register
R32_PWR_AWUPSC 	= 0x40007010 	#Auto-wakeup crossover factor register
...
R32_RCC_RSTSCKR = 0x40021024 	#Control/status register
...
R32_EXTI_INTFR = 0x40010414 	#Interrupt flag register

R32_PFIC_ISR1 = 0xE000E000 	#PFIC interrupt enable status register 1
R32_PFIC_ISR2 = 0xE000E004 	#PFIC interrupt enable status register 2 
R32_PFIC_IPR1 = 0xE000E020 	#PFIC interrupt pending status register 1 
R32_PFIC_IPR2 = 0xE000E024 	#PFIC interrupt pending status register 2 
R32_PFIC_ITHRESDR = 0xE000E040 	#PFIC interrupt priority threshold configuration register
R32_PFIC_CFGR = 0xE000E048 	#PFIC interrupt configuration register
R32_PFIC_GISR = 0xE000E04C 	#PFIC interrupt global status register 
R32_PFIC_VTFIDR = 0xE000E050 	#PFIC VTF interrupt ID configuration register
R32_PFIC_VTFADDRR0 = 0xE000E060 #PFIC VTF interrupt 0 offset address register
R32_PFIC_VTFADDRR1 = 0xE000E064 #PFIC VTF interrupt 1 offset address register
R32_PFIC_IENR1 = 0xE000E100	#PFIC interrupt enable setting register 1 
R32_PFIC_IENR2 = 0xE000E104 	#PFIC interrupt enable setting register 2 
R32_PFIC_IRER1 = 0xE000E180 	#PFIC interrupt enable clear register 1 
R32_PFIC_IRER2 = 0xE000E184 	#PFIC interrupt enable clear register 2 
R32_PFIC_IPSR1 = 0xE000E200 	#PFIC interrupt pending setting register 1 
R32_PFIC_IPSR2 = 0xE000E204 	#PFIC interrupt pending setting register 2 
R32_PFIC_IPRR1 = 0xE000E280 	#PFIC interrupt hang clear register 1 
R32_PFIC_IPRR2 = 0xE000E284 	#PFIC interrupt hang clear register 2 
R32_PFIC_IACTR1 = 0xE000E300 	#PFIC interrupt activation status register1
R32_PFIC_IACTR2 = 0xE000E304 	#PFIC interrupt activation status register2
R32_PFIC_IPRIOR1 = 0xE000E400 	#PFIC interrupt priority configuration register
R32_PFIC_IPRIOR2 = 0xE000E401 	#PFIC interrupt priority configuration register
R32_PFIC_SCTLR = 0xE000ED10 	#PFIC system control register

INTSYSCR = 0x804 		#Interrupt System Control Register
MTVEC = 0x305 			#Exception Entry Base Address Register
DBGMCU_CR = 0x7C0  		#Debug MCU Configuration Register (CSR)
 
R32_STK_CTLR = 0xE000F000 	#System count control register 
R32_STK_SR = 0xE000F004 	#System count status register 
R32_STK_CNTR = 0xE000F008	# System counter low register 
R32_STK_CMPR = 0xE000F010 	#Counting comparison low register
...
R32_GPIOC_BCR = 0x40011014 	#PC port reset register
...
R32_GPIOD_LCKR = 0x40011418 	#PD port configuration lock register 
R32_AFIO_PCFR1 = 0x40010004	#AFIO Remap Register 1
R32_AFIO_EXTICR = 0x40010008 	#External interrupt configuration register 1
...
R32_DMA_CNTR1 = 0x4002000C 	#DMA channel 1 number of data register
...
R32_DMA_MADDR7 = 0x4002008C 	#DMA channel 7 memory address register
...
R32_ADC_DLYR = 0x40012450 	#ADC delayed data register
...
R16_TIM1_DMAADR = 0x40012C4C 	#DMA address register for continuous mode
...
R16_TIM2_DMAINTENR = 0x4000000C 	#TIM2 DMA/interrupt enable register
...
R16_TIM2_DMAADR = 0x4000004C 	#TIM2 DMA address register in continuous mode
...
R32_USART_GPR = 0x40013818 	#UASRT protection time and prescaler register
...
R16_I2C_CKCFGR = 0x4000541C 	#I2C clock register
...
R16_SPI_HSCR = 0x40013024 	#SPI High-speed control register
...
R32_ESIG_UNIID3 = 0x1FFFF7F0 	#UID register 3 

R32_FLASH_ACTLR = 0x40022000 	#Control register
...
R32_FLASH_BOOT_MODEKEYR = 0x40022028 #Unlock BOOT key register

R32_EXTEN_CTR = 0x40023800 	#Configure extended control registers

PFIC_KEY1  =  0xFA050000
PFIC_KEY2  =  0xBCAF0000
PFIC_KEY3  =  0xBEEF0000
mstatus = 0x300
mtvec = 0x305
intsyscr = 0x804
mepc = 0x341

 SYSTICK_SR_CNTIF = (1<<0)
 SYSTICK_CTLR_STE = (1<<0)
 SYSTICK_CTLR_STIE = (1<<1)
 SYSTICK_CTLR_STCLK = (1<<2)
 SYSTICK_CTLR_STRE = (1<<3)
 SYSTICK_CTLR_SWIE = (1<<31) 
